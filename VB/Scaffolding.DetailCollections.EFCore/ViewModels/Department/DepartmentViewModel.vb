...
Namespace Scaffolding.DetailCollections.EFCore.ViewModels
	...
	Partial Public Class DepartmentViewModel
		...
		Public ReadOnly Property LookUpCourses() As IEntitiesViewModel(Of Course)
			Get
				Return GetLookUpEntitiesViewModel(propertyExpression:= Function(x As DepartmentViewModel) x.LookUpCourses, getRepositoryFunc:= Function(x) x.Courses)
			End Get
		End Property
		''' <summary>
		...
		Public ReadOnly Property LookUpEmployees() As IEntitiesViewModel(Of Employee)
			Get
				Return GetLookUpEntitiesViewModel(propertyExpression:= Function(x As DepartmentViewModel) x.LookUpEmployees, getRepositoryFunc:= Function(x) x.Employees)
			End Get
		End Property
		...
		Public ReadOnly Property DepartmentCoursesDetails() As CollectionViewModelBase(Of Course, Course, Integer, IDepartmentContextUnitOfWork)
			Get
				Return GetDetailsCollectionViewModel(propertyExpression:= Function(x As DepartmentViewModel) x.DepartmentCoursesDetails, getRepositoryFunc:= Function(x) x.Courses, foreignKeyExpression:= Function(x) x.DepartmentID, navigationExpression:= Function(x) x.Department)
			End Get
		End Property
		...
		Public ReadOnly Property DepartmentEmployeesDetails() As CollectionViewModelBase(Of Employee, Employee, Integer, IDepartmentContextUnitOfWork)
			Get
				Return GetDetailsCollectionViewModel(propertyExpression:= Function(x As DepartmentViewModel) x.DepartmentEmployeesDetails, getRepositoryFunc:= Function(x) x.Employees, foreignKeyExpression:= Function(x) x.DepartmentID, navigationExpression:= Function(x) x.Department)
			End Get
		End Property
	End Class
End Namespace
